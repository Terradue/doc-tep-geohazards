...
* You are good to go. Click on the button *Run Job* at the bottom of the right panel. Depending on the allocate resources the execution will require at least few hours to terminate.
...
.. note:: The pre-visualization in the *Geobrowser* is very basic and the user is encouraged to download the results for further processing and analysis.
